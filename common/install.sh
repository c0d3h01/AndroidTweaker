...
ui_print ""
ui_print "[ * ] Devloped by @C0d3H01"
ui_print ""
ui_print "[ * ] If you found any bug give report Devloper"
ui_print ""
ui_print "[ * ] Channel @AndroidTweaker"
ui_print ""
}
...
nohup am start -a android.intent.action.VIEW -d https://t.me/Androidtweaker >/dev/null 2>&1 & >/dev/null 2>&1 &